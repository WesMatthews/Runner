...
/**
 * Created by wes_m on 10/25/2016.
 */
...
public class ObstacleManager {
    ...
    public ObstacleManager(int playerGap, int obstaclesGap, int obstacleHeight, int color){
        ...
        this.obstaclesHeight = obstacleHeight;
        this.color = color;
    ...
    private void populateObstacles() {
        ...
        while(currY < 0){
            ...
            obstacles.add(new Obstacle(obstaclesHeight, color, xStart, currY, playerGap));
    ...
    public void update(){
        ...
        if(obstacles.get(obstacles.size() - 1).getRectangle().top >=  Constants.SCREEN_HEIGHT){
            int xStart = (int)(Math.random()*(Constants.SCREEN_WIDTH - playerGap));
            obstacles.add(0, new Obstacle(obstaclesHeight, color, xStart, obstacles.get(0).getRectangle().top - obstaclesHeight - obstaclesGap, playerGap));
